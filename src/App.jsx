...
import {
  Shield, Key, LockKeyhole, BookOpen, Globe,
  Hash, Fingerprint, Lock,
  Code2, AlignLeft, Image,
  Network, FileKey, ShieldAlert,
  Zap, Database, Terminal,
  Calculator, TrendingUp, Sigma,
...
const CATEGORIES = [
  {
    ...
    modules: [
      ...
      { id: 'asymmetric', label: 'Asymmetric Encryption', Icon: LockKeyhole, Component: AsymmetricDemo },
    ],
  },
  {
    id: 'hashing',
    ...
    Icon: Hash,
    modules: [
      { id: 'hash-functions',   label: 'Hash Functions',    Icon: Fingerprint, Component: HashFunctionsDemo },
      { id: 'hmac',             label: 'HMAC',              Icon: Lock,        Component: HMACDemo },
      { id: 'password-hashing', label: 'Password Hashing',  Icon: Key,         Component: PasswordHashingDemo },
    ],
  },
  {
    id: 'encoding',
    ...
    Icon: Code2,
    modules: [
      { id: 'encoding-playground', label: 'Encoding Playground', Icon: AlignLeft, Component: EncodingPlaygroundDemo },
      { id: 'caesar-cipher',       label: 'Caesar / ROT13',      Icon: AlignLeft, Component: CaesarCipherDemo },
  ...
  },
  {
    ...
    modules: [
      ...
      { id: 'xss-playground', label: 'XSS Playground',  Icon: Terminal, Component: XSSPlaygroundDemo },
    ],
  },
  {
    id: 'math',
    ...
    Icon: Calculator,
    modules: [
      { id: 'diffie-hellman', label: 'Diffie-Hellman', Icon: TrendingUp, Component: DiffieHellmanDemo },
      { id: 'ecc',            label: 'ECC',            Icon: Sigma,      Component: ECCDemo },
      { id: 'prime-math',     label: 'Prime & Modular Arithmetic', Icon: Calculator, Component: PrimeMathDemo },
    ],
  },
];
      ...
      <div className="main-area">
        ...
        <footer className="project-footer">
          <div className="project-footer-inner">
            <span>Daddy Omar Jeng &nbsp;·&nbsp;
              <a href="https://www.daddyomarjeng.com" target="_blank" rel="noopener noreferrer" className="footer-link">
