    ...
    <div>
      ...
      <div className="card">
        ...
        <div style={{ color: "var(--text-muted)", fontSize: "0.9rem", lineHeight: 1.8 }}>
          <p style={{ marginBottom: 12 }}>
            <strong style={{ color: "var(--text)" }}>Cryptography Playground</strong> is an open
            source, browser-based cybersecurity toolkit that lets you interactively explore
            fundamental cryptographic techniques used in modern systems — with no server, no data
            collection, and no setup required.
          </p>
          <p style={{ marginBottom: 12 }}>
            The project is built around a{" "}
            <strong style={{ color: "var(--text)" }}>modular architecture</strong> — each
            cybersecurity concept is encapsulated as an independent module, making it easy to
            extend, contribute to, or learn from.
          </p>
          ...
          >
            {[
              {
                cat: "🔐 Cryptography",
                items: ["Symmetric Encryption (AES, 3DES)", "Asymmetric Encryption (RSA)"],
              },
              {
                cat: "🔑 Hashing & Integrity",
                items: ["Hash Functions (MD5–SHA-512)", "HMAC", "Password Hashing (bcrypt/PBKDF2)"],
              },
              {
                cat: "🔠 Encoding & Obfuscation",
                items: [
                  "Encoding Playground (Base64/Hex/URL)",
                  "Caesar / ROT13 Cipher",
                  "Steganography (LSB)",
                ],
              },
              {
                cat: "🌐 Network & Web Security",
                items: ["JWT Tokens", "TLS 1.3 Handshake", "CORS & CSP Simulator"],
              },
              {
                cat: "🛡️ Attack Demonstrations",
                items: ["Brute Force Visualizer", "SQL Injection Demo", "XSS Playground"],
              },
              {
                cat: "🔢 Math Behind Crypto",
                items: [
          ...
          <p>
            All cryptographic operations execute entirely within the user's browser. No data is
            transmitted to any server, making this tool safe for experimentation and learning.
          </p>
        </div>
      </div>
      ...
      <div className="card">
        ...
        >
          {[
            {
              num: "01",
              title: "Demonstrate Symmetric Encryption",
              desc: "Show how AES and Triple DES use a shared secret key to encrypt and decrypt data, illustrating key reuse and mode differences.",
            },
            {
              num: "02",
              title: "Demonstrate Asymmetric Encryption",
              desc: "Show how RSA key pairs enable secure communication where only the private key holder can decrypt messages encrypted with their public key.",
            },
            {
              num: "03",
              title: "Explain Digital Signatures",
              desc: "Demonstrate how private keys create verifiable proofs of authenticity and data integrity using SHA-256 hashing.",
            },
            {
              num: "04",
              title: "Educate on Key Concepts",
              desc: "Provide in-context glossary definitions for all cryptographic terms so learners can understand each concept as they interact with it.",
            },
          ].map((item) => (
            <div
              key={item.num}
      ...
      <div className="card">
        ...
        <div style={{ color: "var(--text-muted)", fontSize: "0.9rem", lineHeight: 1.8 }}>
          <p style={{ marginBottom: 16 }}>
            ...
            <strong style={{ color: "var(--text)" }}>component-based architecture</strong> using
            React (via Vite) to separate concerns cleanly. Each cryptographic algorithm is
            encapsulated in its own component, making the code modular and extensible.
          </p>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            {[
              {
                title: "Frontend Framework",
                body: "React 18 with Vite as the build tool. Functional components with React Hooks (useState, useEffect) manage all application state.",
              },
              {
                title: "Client-Side Only",
                body: "All cryptographic operations run in the browser using JavaScript libraries. No backend server, no data storage, no network requests during encryption.",
              },
              {
                title: "Real Algorithms",
                body: "Production-grade cryptographic libraries (not custom implementations) are used to ensure correctness and to demonstrate real-world encryption behavior.",
              },
              {
                title: "Glossary-Driven UI",
                body: "Every cryptographic term in the UI is linked to a glossary entry via an info icon, supporting self-paced learning without leaving the demo context.",
              },
            ].map((item) => (
              <div
                key={item.title}
      ...
      <div className="card">
        ...
        >
          ...
          >
            CryptoJS is a comprehensive JavaScript library implementing standard cryptographic
            algorithms. It was originally developed by Jeff Mott and is widely used for client-side
            cryptography. In this project it provides the symmetric encryption module.
          </p>
          <div
            style={{
              display: "grid",
        ...
        >
          ...
          >
            node-forge is a native JavaScript implementation of the TLS protocol and various
            cryptography tools. It provides a full PKI (Public Key Infrastructure) toolkit including
            RSA key generation, PKCS certificate handling, and digital signatures — suitable for
          ...
          >
            {[
              { label: "RSA Key Generation", detail: "1024 / 2048 / 4096-bit key pair generation" },
              {
                ...
                detail: "Secure asymmetric encryption with OAEP padding",
              },
              {
                label: "Digital Signatures",
                detail: "SHA-256 + RSA PKCS#1 v1.5 signing & verification",
              },
          ...
          <div style={{ marginTop: 12, fontSize: "0.8rem", color: "var(--text-muted)" }}>
            ...
            <a
              href="https://github.com/digitalbazaar/forge"
              target="_blank"
              rel="noopener noreferrer"
              style={{ color: "var(--accent)" }}
            >
          ...
          {[
            {
              name: "React 18",
              role: "UI Framework",
              desc: "Component-based frontend library by Meta",
            },
            {
              name: "Vite",
              role: "Build Tool",
              desc: "Fast dev server and bundler using Rolldown",
            },
            {
              name: "crypto-js 4",
              role: "Symmetric Crypto",
              desc: "AES, 3DES, HMAC, hashing utilities",
            },
            {
              name: "node-forge 1",
              role: "Asymmetric Crypto",
              desc: "RSA, PKI, TLS, X.509 certificates",
            },
            {
              name: "lucide-react",
              role: "Icon Library",
              desc: "Clean SVG icon set for React applications",
            },
            {
              name: "CSS Variables",
              role: "Styling",
              desc: "Custom dark theme with CSS custom properties",
            },
          ].map((item) => (
            <div
              key={item.name}
            ...
            >
              ...
              <div style={{ fontSize: "0.74rem", color: "var(--accent)", margin: "4px 0" }}>
                {item.role}
              </div>
          ...
          {[
            {
              ...
              role: "Senior Solutions Architecture",
            ...
            <div key={i} style={{ display: "flex", gap: 16, marginBottom: 20 }}>
              ...
              <div style={{ paddingBottom: 4 }}>
                ...
                <div style={{ display: "flex", gap: 12, marginBottom: 6, flexWrap: "wrap" }}>
                  <span style={{ fontSize: "0.82rem", color: job.color, fontWeight: 600 }}>
                    {job.role}
                  </span>
      ...
      <div
        style={{
          ...
          padding: 2,
          background:
            "linear-gradient(135deg, rgba(88,166,255,0.6), rgba(63,185,80,0.5), rgba(210,153,34,0.4))",
          marginBottom: 0,
        }}
      >
        <div style={{ borderRadius: 10, background: "var(--surface)", padding: "32px 28px" }}>
          <div style={{ textAlign: "center", marginBottom: 24 }}>
            ...
            <h2 style={{ margin: "0 0 8px", fontSize: "1.4rem", color: "var(--text)" }}>
            ...
            >
              I'm a full-stack software engineer with experience building fintech products,
              government digital platforms, and cross-platform mobile apps. Whether you need a
              collaborator on an open source project, a freelance engineer, or a full-time hire —
